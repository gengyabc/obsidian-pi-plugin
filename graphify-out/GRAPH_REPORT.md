...
## Corpus Check
- 30 files · ~24,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 888 nodes · 1561 edges · 46 communities (33 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae20ba0b`
...
- `parseModelsJson()` --calls--> `isRecord()`  [EXTRACTED]
  src/pi-config-reader.ts → src/json-utils.ts
...
Cohesion: 0.09
Nodes (27): getArray(), getBoolean(), getNumber(), getRecord(), getString(), isRecord(), parseJsonRecord(), getProviderEnvVarName() (+19 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (45): addAttachment(), browseSessions(), buildSessionEntries(), cancelRewindAfterExtensionUi(), childProcessModule, clearAttachments(), convertAgentMessage(), ensureDirectory() (+37 more)
...
Cohesion: 0.21
Nodes (12): activateView(), autoSave(), flushMessageStore(), getActiveView(), hasMessages(), isDirty(), newSession(), onunload() (+4 more)
...
Cohesion: 0.05
Nodes (21): DesktopVaultAdapter, isDesktopVaultAdapter(), ModelOption, ModelSwitchModal, PiPlugin, ApiKeyModal, DEFAULT_SETTINGS, DropdownControl (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (5): AttachmentPicker, FileSuggestModal, Attachment, ChatInput, ChatInputCallbacks

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (29): abortStream(), addActionButton(), addMessage(), appendMessage(), constructor(), handleStreamComplete(), load(), loadMessageStore() (+21 more)
...
Cohesion: 0.09
Nodes (21): AgentEndEvent, AgentStartEvent, AssistantMessageEvent, AutoCompactionEndEvent, CreateLineReader, EventHandler, MessageEndEvent, MessageStartEvent (+13 more)
...
Cohesion: 0.18
Nodes (8): App, Component, ItemView, MarkdownRenderer, Notice, Platform, PluginSettingTab, WorkspaceLeaf
...
## Knowledge Gaps
- **266 isolated node(s):** `PiModelConfig`, `PiProviderConfig`, `PiModelsJson`, `ModelInfo`, `RpcChildProcess` (+261 more)
...
- **Why does `PiConnection` connect `Community 16` to `Community 26`, `Community 12`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `PiChatView` connect `Community 4` to `Community 1`, `Community 12`?**
