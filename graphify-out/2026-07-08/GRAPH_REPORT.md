...
## Corpus Check
- 30 files · ~24,122 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 885 nodes · 1558 edges · 50 communities (35 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad3ffb91`
...
- `parseRpcEvent()` --calls--> `parseJsonRecord()`  [EXTRACTED]
  src/rpc.ts → src/json-utils.ts
- `isContentBlock()` --calls--> `isRecord()`  [EXTRACTED]
  src/view.ts → src/json-utils.ts
...
Cohesion: 0.31
Nodes (9): clearMessages(), displayMessages(), handleDisconnect(), handleStreamUpdate(), onClose(), removeThinkingIndicator(), reset(), setEnabled() (+1 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (44): addAttachment(), browseSessions(), buildSessionEntries(), childProcessModule, clearAttachments(), convertAgentMessage(), ensureDirectory(), exportSession() (+36 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (13): getArray(), getBoolean(), getNumber(), getRecord(), getString(), PiSession, ContentBlock, ExtensionUiRequest (+5 more)

### Community 5 - "Community 5"
Cohesion: 0.19
Nodes (10): DesktopVaultAdapter, ModelOption, DEFAULT_SETTINGS, DropdownControl, PiPluginSettings, SettingControl, SettingGroupDefinition, SettingItem (+2 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (28): buildHeaderBar(), confirmDelete(), createNodePathSetting(), createPiBinaryPathSetting(), createProviderModelSettings(), display(), escapeRegex(), focus() (+20 more)
...
Cohesion: 0.31
Nodes (9): activateView(), autoSave(), getActiveView(), hasMessages(), newSession(), onunload(), saveCurrentSession(), sendPiCommand() (+1 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (22): isRecord(), parseJsonRecord(), getProviderEnvVarName(), getProviderModels(), ModelInfo, parseModelsJson(), PiModelConfig, PiModelsJson (+14 more)
...
Cohesion: 0.10
Nodes (26): abortStream(), addActionButton(), addMessage(), appendMessage(), constructor(), handleStreamComplete(), load(), looksLikeMarkdown() (+18 more)
...
Cohesion: 0.09
Nodes (19): AgentEndEvent, AgentStartEvent, AssistantMessageEvent, AutoCompactionEndEvent, ChildProcess, EventHandler, MessageEndEvent, MessageStartEvent (+11 more)
...
Cohesion: 0.24
Nodes (11): buildCurrentMessage(), extractResultText(), extractTextFromMessage(), extractThinkingFromMessage(), handleEvent(), handleMessageEnd(), handleMessageStart(), handleMessageUpdate() (+3 more)
...
Cohesion: 0.09
Nodes (10): App, Component, FuzzySuggestModal, ItemView, MarkdownRenderer, Notice, Platform, PluginSettingTab (+2 more)
...
Cohesion: 0.17
Nodes (15): cleanup(), commitSessionNameEdit(), connect(), connectToRpc(), createConnection(), destroy(), ensureConnection(), isDesktopVaultAdapter() (+7 more)

### Community 29 - "Community 29"
Cohesion: 0.33
Nodes (6): normalizeThinkingLevel(), PI_THINKING_LEVEL_SET, PI_THINKING_LEVELS, PiThinkingLevel, resolveDisplayedThinkingLevel(), shouldDisplayThinkingLevel()

### Community 32 - "Community 32"
Cohesion: 0.33
Nodes (7): cancelRewindAfterExtensionUi(), handleExtensionUiRequest(), respondToExtensionConfirm(), respondToExtensionInput(), respondToExtensionSelect(), sendExtensionUiResponse(), sendRaw()
...
## Knowledge Gaps
- **266 isolated node(s):** `Platform`, `App`, `PluginSettingTab`, `WorkspaceLeaf`, `ModelOption` (+261 more)
...
- **Why does `PiPlugin` connect `Community 12` to `Community 4`, `Community 5`, `Community 10`, `Community 16`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **What connects `Platform`, `App`, `PluginSettingTab` to the rest of the system?**
